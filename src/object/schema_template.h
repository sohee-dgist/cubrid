...
extern int smt_add_histogram (SM_TEMPLATE * template_, const char *attr_name, int data_type, int histogram_type,
			      int bucket_count);
...
extern int smt_check_histogram_exist (SM_TEMPLATE * template_, const char *attr_name);
