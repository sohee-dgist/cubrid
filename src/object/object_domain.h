...
/* value functions */
  ...
  extern DB_VALUE_COMPARE_RESULT tp_value_compare_with_no_error_with_same_type (const DB_VALUE * value1, const DB_VALUE * value2, int do_coercion, int total_order, bool * can_compare);
